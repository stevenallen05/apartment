...
module Apartment
  module Tenant
    def self.cockroachdb_adapter(config)
      adapter = Adapters::CockroachDbAdapter
      adapter = Adapters::CockroachDbSchemaAdapter if Apartment.use_schemas
      adapter = Adapters::CockroachDbSchemaFromSqlAdapter if Apartment.use_sql && Apartment.use_schemas
      adapter.new(config)
    end
  end

  module Adapters
    # Default adapter when not using CockroachDb Schemas
    ...
    # Separate Adapter for CockroachDb when using schemas
    class CockroachDbSchemaAdapter < AbstractAdapter
    ...
    # Another Adapter for CockroachDb when using schemas and SQL
    class CockroachDbSchemaFromSqlAdapter < CockroachDbSchemaAdapter
      ...
      # Temporary set CockroachDb related environment variables if there are in @config
      #
